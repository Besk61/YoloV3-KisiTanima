...
cap = cv2.VideoCapture("vids/as2.mp4")
...
while True:
    ...
    labels = ["insan", "bicycle", "car", "motorcycle", "airplane", "bus", "train", "truck", "boat",
    ...
    vid=cv2.VideoWriter("fotos/rapor/1.avi", cv2.VideoWriter_fourcc("X","V","I","D"),30,(640,480))
    vid.write(frame)
